...
export default function About() {
  ...
  return (
    <section ref={sectionRef} aria-label="О платформе" className="relative bg-white py-16 md:py-40 px-6 md:px-10 overflow-hidden">
              ...
              <div
                ...
                style={{
                  background: item.dark
                    ? item.id === "origin"
                      ? `linear-gradient(165deg, rgba(4, 0, 130, 0.44) 0%, rgba(6, 6, 50, 0.46) 45%, rgba(2, 2, 25, 0.48) 100%), url(/CASElab.webp)`
