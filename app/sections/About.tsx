...
export default function About() {
  ...
  return (
    <section ref={sectionRef} aria-label="О платформе" className="relative bg-white py-24 md:py-40 px-6 md:px-10 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div ref={headingRef} className="mb-12 md:mb-20">
          ...
          >
            ...
            <span className="border-b-2 border-[#040082] pb-1 mb-1 about-word inline-block" style={{ willChange: "filter, opacity, transform" }}>
              экспертизы
            </span>{" "}
