...
export default function OurAdvantage() {
  ...
  return (
    <section aria-label="Когда нужна диагностика" className="relative bg-white py-24 md:py-40 px-6 md:px-10 overflow-hidden">
      {/* Gradient divider */}
        ...
        >
          {pains.map((pain, i) => {
            ...
            return (
              ...
              >
                <motion.div
                      className="relative rounded-[16px] border border-black/[0.08] bg-white p-6 md:p-8 overflow-hidden flex flex-col h-full"
                  animate={{
                    y: isHovered ? -6 : 0,
