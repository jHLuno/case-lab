...
export default function Timeline() {
  ...
  return (
    <section ref={sectionRef} id="process" tabIndex={-1} aria-label="Процесс диагностики" className="relative bg-white py-16 md:py-40 px-6 md:px-10">
      ...
      <div className="max-w-[1078px] mx-auto">
        ...
        <div ref={headerRef}>
          ...
          <h2
            className="text-black text-[clamp(24px,4vw,54px)] font-bold leading-[1.15] mb-12 md:mb-20 uppercase tracking-[0.02em] flex flex-wrap gap-x-[0.25em]"
