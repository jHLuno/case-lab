...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      "Сессия дала нам не абстрактую стратегию, а рабочую основу EVP. Впервые HR, коммуникации и руководство увидели, как мы говорим с рынком труда одним голосом, и согласовали первые шаги по внедрению.",
    role: "Крупная финансовая компания",
  },
];
