...
const proPlan = {
  ...
  features: [
    ...
    "Комплексное внедрение — 2 недели",
    "Дополнительные услуги (фото/видео)",
  ],
  cta: "Выбрать пакет",
  popular: true,
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-9 md:pl-[60px] md:pr-10 md:py-10 lg:pl-[60px] lg:pr-12 lg:py-12 flex flex-col h-full">
          {/* Badge */}
          <span
          ...
          {/* Name */}
          <h3
            className="text-white text-[clamp(17px,3vw,36px)] font-normal uppercase leading-[1.1] tracking-[0.02em] mb-6"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {plan.name}
          </h3>
...
export default function Pricing() {
  ...
  return (
    <section ref={sectionRef} id="diagnostics" aria-label="Форматы диагностики" className="relative bg-white py-16 md:py-40 px-6 md:px-10 overflow-clip">
