...
const faqItems = [
  {
    ...
    answer:
      "Нет, участвовать можно и одному. Но EVP касается найма, бренда и репутации сразу, поэтому максимум пользы сессия даёт, когда CEO, HR и маркетинг работают над ним вместе.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Оставьте заявку через кнопку «Забронировать место» — мы свяжемся с вами в течение рабочего дня, ответим на вопросы и подтвердим участие.",
  },
];
...
export default function EVPProFAQ() {
  ...
  return (
    <section id="faq" tabIndex={-1} aria-labelledby="evp-faq-title" className="bg-white px-6 py-24 md:px-10 md:py-40">
