      ...
      <div className="mx-auto max-w-[1078px]">
        ...
        <div className="mb-12 flex flex-col items-start gap-8 md:grid md:grid-cols-3 md:items-center">
          ...
          <div className="w-full text-center">
            <a
              ...
              className="text-[15px] font-light text-black/60 transition-colors duration-200 hover:text-black"
              style={{ fontFamily: "var(--font-body)" }}
            >
              hello@caselab.kz
            </a>
          ...
          <div className="flex flex-wrap items-center gap-4 md:justify-self-end md:gap-6">
            <a
              ...
              className="text-[15px] font-light text-gray transition-colors duration-200 hover:text-black"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Instagram Case Lab
            </a>
        ...
        <div className="flex flex-col items-start justify-between gap-4 border-t border-black/5 pt-6 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <a
              href="/privacy/"
              className="text-[12px] font-light text-black/60 transition-colors duration-200 hover:text-black/80"
              style={{ fontFamily: "var(--font-body)" }}
            >
