alter function public.case_lab_3_create_payment_attempt(uuid)
  rename to case_lab_3_create_payment_attempt_legacy;
...
revoke all on function public.case_lab_3_create_payment_attempt_legacy(uuid) from public, anon, authenticated;

grant execute on function public.case_lab_3_create_payment_attempt(uuid) to service_role;
grant execute on function public.case_lab_3_create_payment_attempt_legacy(uuid) to service_role;
